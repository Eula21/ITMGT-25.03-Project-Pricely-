...
def scrape_ebay(query):
    ...
    with sync_playwright() as p:
        ...
        try:
            page.goto("https://www.ebay.com/", timeout=60000, wait_until="domcontentloaded")
        except Exception as e:
            print("[eBay] First attempt failed:", e)
            time.sleep(3)
            try:
                page.goto("https://www.ebay.com/", timeout=60000, wait_until="domcontentloaded")
            except Exception as e2:
                print("[eBay] Failed to load homepage after retry:", e2)
                browser.close()
                return []
        ...
        products = page.query_selector_all("li.s-item")[:8]
