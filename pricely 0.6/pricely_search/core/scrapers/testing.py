...
query = "laptop"  # You can change this to test other queries
    ...
    with sync_playwright() as p:
        ...
        for product in products:
            try:
                ...
                Amazon_list_of_products.append(product_info)
...
for idx, item in enumerate(Amazon_list_of_products, start=1):
    print(f"\nProduct {idx}:")
